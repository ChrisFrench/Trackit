...
<?php JHTML::_('script', 'common.js', 'media/com_trackit/js/'); ?>
...
<form action="<?php echo JRoute::_( @$form['action'] )?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
	...
	<tr>
		<td style="width: 70%; max-width: 70%; vertical-align: top; padding: 0px 5px 0px 5px;">
			...
			<?php
			$modules = JModuleHelper::getModules("trackit_dashboard_main");
		...
		<td style="vertical-align: top; width: 30%; min-width: 30%; padding: 0px 5px 0px 5px;">
			...
			<?php
			$modules = JModuleHelper::getModules("trackit_dashboard_right");
			$document	= JFactory::getDocument();
			$renderer	= $document->loadRenderer('module');
			$attribs 	= array();
			$attribs['style'] = 'xhtml';
