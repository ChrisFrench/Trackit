...
<form action="<?php echo JRoute::_( @$form['action'] ) ?>" method="post" class="adminform" name="adminForm" id="adminForm" enctype="multipart/form-data" >
	...
	<fieldset>
		...
		<table class="admintable">
			...
			<tr>
				<td class="key"> <?php echo JText::_('Object ID'); ?>: </td>
				<td>
				<input name="object_id" value="<?php echo @$row -> object_id; ?>" size="50" maxlength="250" type="text" style="font-size: 20px;" />
				</td>
			</tr>	
			...
			<tr>
				<td class="key"> <?php echo JText::_('VIEWED'); ?>: </td>
				<td>
				<input name="viewed" value="<?php echo @$row -> viewed; ?>" size="50" maxlength="250" type="text" style="font-size: 20px;" />
				</td>
			</tr>
			<tr>
				<td class="key"> <?php echo JText::_('PLAYED'); ?>: </td>
				<td>
				<input name="played" value="<?php echo @$row -> played; ?>" size="50" maxlength="250" type="text" style="font-size: 20px;" />
				</td>
			</tr>

			<tr>
				<td class="key"> <?php echo JText::_('Date Created'); ?>: </td>
				<td> <?php echo JHTML::calendar(@$row -> createdate, 'createdate', 'createdate', ''); ?> </td>
			</tr>
			<tr>
