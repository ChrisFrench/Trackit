...
class Trackit extends DSC
{
    protected $_name = 'trackit';
    ...
    {
        $query = "SELECT * FROM #__trackit_config";
        return $query;
    }
    ...
    {
        $cache = JFactory::getCache('com_trackit.defines');
     ...
     *
     * Usage: $object = Trackit::getClass( 'TrackitHelperCarts', 'helpers.carts' );
     * Usage: $suffix = Trackit::getClass( 'TrackitHelperCarts', 'helpers.carts' )->getSuffix();
     * Usage: $categories = Trackit::getClass( 'TrackitSelect', 'select' )->category( $selected );
     *
     ...
     */
    public static function getClass( $classname, $filepath='controller', $options=array( 'site'=>'admin', 'type'=>'components', 'ext'=>'com_trackit' )  )
    {
     ...
     * @return boolean
     */
    public static function load( $classname, $filepath='controller', $options=array( 'site'=>'admin', 'type'=>'components', 'ext'=>'com_trackit' ) )
    {
